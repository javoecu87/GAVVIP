...
def solicitar_taxi():
    try:
        ...
        lat = request.form.get('lat')  # Coordenada de latitud
        lng = request.form.get('lng')  # Coordenada de longitud
        ...
        mensaje = (
            ...
            f"🌍 Ubicación: [Ver en el mapa](https://www.google.com/maps?q={lat},{lng})"
        )
